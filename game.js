...
void setup()
 ...
 beaverImage = loadImage("Hopper-Happy.png");
 beaverhopImage = loadImage("Hopper-Jumping.png");
 beaverfallImage = loadImage("Hopper-Happy.png"); 
 grassImage = loadImage("Grass Block.png");
 monsterImage = loadImage("old-spice-man.png");
 ohnoesImage = loadImage("OhNoes.png");
 
 console.log(beaverhopImage);
 console.log(beaverImage);
 console.log(beaverfallImage);
 console.log(monsterImage);
 console.log(ohnoesImage);
 }      
